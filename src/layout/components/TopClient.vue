		...
		<nav class="navbar navbar-expand">
			<router-link to="/">
				<div class="topbar-logo-header d-flex align-items-center">
						<img src="https://i.pinimg.com/474x/7f/f4/a9/7ff4a90e1d5c45f7c0e1bf7ef772ba27.jpg" class="logo-icon" style="width: 70px;"
							alt="logo icon">
						<h4 class="mt-3 ms-2">HOCMAI</h4>
				</div>
			</router-link>
			...
			<div class="user-box dropdown">
				<template v-if="user.check">
					<a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#"
						...
						<img src="https://i.pinimg.com/474x/7f/f4/a9/7ff4a90e1d5c45f7c0e1bf7ef772ba27.jpg" class="user-img" alt="user avatar">
