            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content shadow-lg border-0">
                    <div class="modal-header bg-primary text-white">
                        <h5 class="modal-title" id="ketQuaModalLabel">Kết Quả Bài Làm</h5>
                        <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"
                            aria-label="Close"></button>
                    </div>
                    <div class="modal-body text-center p-4">
                        <i class="fa-solid fa-circle-check text-success" style="font-size: 50px;"></i>
                        <h4 class="mt-3">Bạn đã làm đúng</h4>
                        <h2 class="text-primary fw-bold">{{ ketQua }}/{{ tongCau }} câu</h2>
                    </div>
    ...
    methods: {
        ...
        nopBai()
        {
            ...
            axios
                ...
                .then((res) => {
                    this.ketQua = res.data.so_cau_dung;
                    let myModal = new bootstrap.Modal(document.getElementById("ketQuaModal"));
                    myModal.show();
                })
                .catch((res) => {
